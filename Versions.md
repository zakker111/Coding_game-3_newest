...
- Repo status alignment:
  - the current `apps/server` implementation already satisfies the Phase 8A sandbox-runner contract in-repo
  - broader Phase 8 work remains open around scheduling/standings and backend product hardening
